	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IPAddressAllocation represents a single resolved IP allocation with its actual IP address (computed from the CIDR base and offset key).",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"ip": {
						SchemaProps: spec.SchemaProps{
							Description: "IP is the resolved IP address for this allocation.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"podRef": {
						SchemaProps: spec.SchemaProps{
							Description: "PodRef is the namespace/name reference of the pod that owns this allocation.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"ifName": {
						SchemaProps: spec.SchemaProps{
							Description: "IfName is the network interface name inside the pod.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
				},
				Required: []string{"ip", "podRef"},
			},
		},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"id": {
						SchemaProps: spec.SchemaProps{
							Description: "ContainerID is the identifier of the container that owns this allocation.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"ifname": {
						SchemaProps: spec.SchemaProps{
							Description: "IfName is the network interface name inside the pod for this allocation.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
				},
				Required: []string{"id", "podref"},
			},
		},
	}
}
...
func schema_whereabouts_api_whereaboutscnicncfio_v1alpha1_IPPoolList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IPPoolList contains a list of IPPool.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"firstIP": {
						SchemaProps: spec.SchemaProps{
							Description: "FirstIP is the first usable IP address in the pool's range.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"lastIP": {
						SchemaProps: spec.SchemaProps{
							Description: "LastIP is the last usable IP address in the pool's range.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"totalIPs": {
						SchemaProps: spec.SchemaProps{
							Description: "TotalIPs is the total number of usable IPs in the pool's CIDR range (excluding network and broadcast addresses).",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"usedIPs": {
						SchemaProps: spec.SchemaProps{
							Description: "UsedIPs is the number of IPs currently allocated from the pool.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"freeIPs": {
						SchemaProps: spec.SchemaProps{
							Description: "FreeIPs is the number of IPs available for allocation (totalIPs - usedIPs).",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"orphanedIPs": {
						SchemaProps: spec.SchemaProps{
							Description: "OrphanedIPs is the number of allocations whose pods no longer exist, as detected during the last reconciliation.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"pendingPods": {
						SchemaProps: spec.SchemaProps{
							Description: "PendingPods is the number of allocations whose pods are still in the Pending phase, as detected during the last reconciliation.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"overlappingReservations": {
						SchemaProps: spec.SchemaProps{
							Description: "OverlappingReservations is the number of OverlappingRangeIPReservation CRDs that correspond to allocations in this pool.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"allocatedIPs": {
						SchemaProps: spec.SchemaProps{
							Description: "AllocatedIPs is a list of resolved IP-to-pod assignments derived from the spec allocations offset map. Provides a human-readable view of the pool's current allocations.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_whereabouts_api_whereaboutscnicncfio_v1alpha1_NodeSliceAllocation(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NodeSliceAllocation represents a single node-to-slice assignment.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"nodeName": {
						SchemaProps: spec.SchemaProps{
							Description: "NodeName is the name of the node assigned to this slice. An empty node name indicates that this slice is available for assignment.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Required: []string{"nodeName", "sliceRange"},
			},
		},
	}
}
...
func schema_whereabouts_api_whereaboutscnicncfio_v1alpha1_NodeSlicePool(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NodeSlicePool is the Schema for the nodeslicepools API.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_whereabouts_api_whereaboutscnicncfio_v1alpha1_NodeSlicePoolList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NodeSlicePoolList contains a list of NodeSlicePool.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"range": {
						SchemaProps: spec.SchemaProps{
							Description: "Range is a RFC 4632/4291-style string that represents an IP address and prefix length in CIDR notation. This refers to the entire range where the node is allocated a subset.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"sliceSize": {
						SchemaProps: spec.SchemaProps{
							Description: "SliceSize is the size of subnets or slices of the range that each node will be assigned. The value must be a numeric prefix length, optionally preceded by a slash (e.g. \"24\" or \"/24\"). Semantic validation is performed by the validating webhook.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Required: []string{"range", "sliceSize"},
			},
		},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"totalSlices": {
						SchemaProps: spec.SchemaProps{
							Description: "TotalSlices is the total number of IP slices in the pool.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"assignedSlices": {
						SchemaProps: spec.SchemaProps{
							Description: "AssignedSlices is the number of slices currently assigned to nodes.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"freeSlices": {
						SchemaProps: spec.SchemaProps{
							Description: "FreeSlices is the number of slices available for node assignment.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_whereabouts_api_whereaboutscnicncfio_v1alpha1_OverlappingRangeIPReservationList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OverlappingRangeIPReservationList contains a list of OverlappingRangeIPReservation.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"containerid": {
						SchemaProps: spec.SchemaProps{
							Description: "ContainerID is the identifier of the container that owns this reservation.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"podref": {
						SchemaProps: spec.SchemaProps{
							Description: "PodRef is the namespace/name reference of the pod that owns this reservation.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"ifname": {
						SchemaProps: spec.SchemaProps{
							Description: "IfName is the network interface name inside the pod for this reservation.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_whereabouts_api_whereaboutscnicncfio_v1alpha1_OverlappingRangeIPReservationStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OverlappingRangeIPReservationStatus defines the observed state of OverlappingRangeIPReservation.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"conditions": {
						SchemaProps: spec.SchemaProps{

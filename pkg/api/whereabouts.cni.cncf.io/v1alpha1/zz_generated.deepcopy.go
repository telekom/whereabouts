...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OverlappingRangeIPReservationStatus) DeepCopyInto(out *OverlappingRangeIPReservationStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]v1.Condition, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OverlappingRangeIPReservationStatus.
func (in *OverlappingRangeIPReservationStatus) DeepCopy() *OverlappingRangeIPReservationStatus {
	if in == nil {
		return nil
	}
	out := new(OverlappingRangeIPReservationStatus)
	in.DeepCopyInto(out)
	return out
}
